    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/mirage" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/toyotavios.png" alt="Toyota vios" className="car-image" />
          <Link to="/almera" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">TOYOTA VIOS</h1>
          ...
          <p className="price">₱3,500 per day</p>
        </div>
      </section>
