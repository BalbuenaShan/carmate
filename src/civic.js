...
function Civic() {
  ...
  const handleRentClick = () => {
    navigate('/payment'); // Replace with your desired path
  };
    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/almera" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/HondaCivic.png" alt="Honda Civic" className="car-image" />
          <Link to="/Mirage" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">HONDA CIVIC</h1>
          ...
          <div className="vehicle-features">
            ...
            <ul>
              ...
              <li>Air Conditioning & Dual-Zone Climate Control</li>
              <li>Fuel-Efficient Turbocharged Engine</li>
              <li>Spacious & Sporty Interior</li>
            </ul>
          </div>
