    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/land-rover" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/Nissanterra.png" alt="Nissan Tera" className="car-image" />
          <Link to="/toyota-fortuner" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">NISSAN TERRA</h1>
