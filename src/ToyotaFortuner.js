    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/nissan-terra" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/toyotafortuner.png" alt="Toyota Fortuner" className="car-image" />
          <Link to="/mitsubishi-montero" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">TOYOTA FORTUNER</h1>
          ...
          <p className="price">₱3,000 per day</p>
        </div>
      </section>
