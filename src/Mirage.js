    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/civic" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/mitsubishimirage.png" alt="mirage" className="car-image" />
          <Link to="/vios" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">MITSUBISHI MIRAGE</h1>
