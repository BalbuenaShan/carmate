    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/hiace" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/toyotastaria.png" alt="Toyota Staria" className="car-image" />
          <Link to="/alphard" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">HYUNDAI STARIA</h1>
          ...
          <div className="vehicle-features">
            ...
            <ul>
              ...
              <li>Spacious & Flexible Seating</li>
              <li>Advanced Safety Features</li>
              <li>Powerful & Efficient Engine</li>
              <li>High-Tech Infotainment System</li>
              <li>Luxury & Comfort Features</li>
            </ul>
          </div>
