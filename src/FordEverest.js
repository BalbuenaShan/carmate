    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/isuzu-mux" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/FORDEVEREST.png" alt="FORD EVEREST" className="car-image" />
          <Link to="/land-rover" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">FORD EVEREST</h1>
          ...
          <p className="price">₱4,000 for 10 hours</p>
        </div>
      </section>
