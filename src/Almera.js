    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/vios" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/nissanalmera.png" alt="NISSAN ALMERA" className="car-image" />
          <Link to="/civic" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">NISSAN ALMERA</h1>
