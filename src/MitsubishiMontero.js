    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/toyota-fortuner" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/MITSUBISHI.png" alt="Mitsubishi Montero" className="car-image" />
          <Link to="/isuzu-mux" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">MITSUBISHI MONTERO</h1>
...
export default MitsubishiMontero;