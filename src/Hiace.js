    ...
    <div className="car-rental-container">
      ...
      <section className="hero-section">
        <div className="car-image-container">
          <Link to="/alphard" className="arrow left-arrow">
            &lt;
          </Link>
          <img src="/toyotahiace.png" alt="Toyota Hiace" className="car-image" />
          <Link to="/staria" className="arrow right-arrow">
            &gt;
          </Link>
        </div>

        <div className="car-details">
          <h1 className="car-model">TOYOTA HIACE</h1>
